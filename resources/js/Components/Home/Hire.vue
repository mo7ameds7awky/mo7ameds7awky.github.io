            ...
            <div class="w-full grid lg:grid-cols-2 gap-8 lg:gap-32 mt-24">
                <div class="space-y-12">
                    ...
                    <div>
                        ...
                        <input class="w-full border border-input-border bg-input px-4 py-4" type="email">
                    </div>
                    <div>
                        <label class="text-white block mb-6 text-xl font-bold">Message</label>
                        <textarea class="w-full border border-input-border bg-input px-4 py-4 h-56 resize-none"
                                  type="email"></textarea>
                    </div>
                ...
                <div class="mt-12">
                    <!-- Contact info -->
                    <p class="text-secondary">(+20) 112-469-4396</p>
                    <a class="text-secondary underline mt-3 block"
                       href="mailto:mohamed@mohamedshawky.me">mohamed@mohamedshawky.me</a>

                    <!-- Socials -->
                    <div class="flex mt-20 space-x-6">
                        <!-- Skype -->
                        <a href="#">
                            <svg class="w-8 h-8 lg:w-12 lg:h-12" fill="none" height="50" viewBox="0 0 50 50" width="50"
                        ...
                        <!-- Twitter -->
                        <a href="#">
                            <svg class="w-8 h-8 lg:w-12 lg:h-12" fill="none" height="42" viewBox="0 0 42 42" width="42"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
