<template>
    <header class="py-6">
        <div class="container flex justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full">
            <div class="text-lg font-bold">MohamedShawky.Me</div>
            <div class="hidden md:flex space-x-12 items-center">
                <a class="text-selected-text" href="#">Home</a>
        ...
        <div class="flex flex-wrap md:flex-nowrap">
            ...
            <nav class="inline-block lg:mr-24 lg:w-4 fixed left-percentage hidden xl:block">
                <div class="absolute left-50 transform -translate-x-1/2 space-y-6 mt-36">
                    <a class="nav-dot selected-circle block w-7 h-7 rounded-full border-4 border-nav bg-body" href="#">
                        <span class="bg-black px-2 py-1 rounded-md ml-10 opacity-0">Home</span>
                    </a>
                    <a class="nav-dot block w-7 h-7 rounded-full border-4 border-nav bg-body" href="#work">
                        <span class="bg-black px-2 py-1 rounded-md ml-10 opacity-0">Work</span>
                    </a>
                    <a class="nav-dot block w-7 h-7 rounded-full border-4 border-nav bg-body" href="#clients">
                        <span class="bg-black px-2 py-1 rounded-md ml-10 opacity-0">Clients</span>
                    </a>
                    <a class="nav-dot block w-7 h-7 rounded-full border-4 border-nav bg-body" href="#hire">
            ...
            <div class="flex flex-wrap lg:ml-20 justify-center md:justify-start max-w-xl mt-0 md:my-36">
                <h1 class="font-bold text-5xl md:text-6xl lg:text-7xl text-center md:text-left">Building<br> beautiful
                    web experiences.</h1>
            ...
            <img alt="Man" class="w-3/4 mt-12 md:absolute -mt-6 md:mt-0 right-0 -z-1" src="/images/man.png">
        </div>
    </div>
</template>
